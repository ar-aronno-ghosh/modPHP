...
let confirmPasswordInput = document.querySelector("#confirm_password"),
  messageDiv = document.querySelector("#message"), // add this line
  signupBtn = document.querySelector("#signup-btn"); // add this line
...
function checkPassword() {//Add this function
  const message =
    passwordInput.value === confirmPasswordInput.value
      ? ""
      : "Passwords do not match";
  messageDiv.textContent = message;// show error message

  if (message === '') {
    signupBtn.disabled = false;//enable button when there's no mismatch
  } else {
    signupBtn.disabled = true;//disable button with mismatched passwords.
  }

}

//Hook up event listeners - Add these at bottom
