  ...
  <div class="hero">
    <div class="login-card">
      ...
      <form class="login-form" action="process_signup.php" method="post">
        ...
        <input spellcheck="false" class="control" id="password" name="password" type="password"
          placeholder="Password" onkeyup="handleChange()"/>
        <input spellcheck="false" class="control" id="confirm-password" type="password" placeholder="Confirm Password"
          name="confirm_password" onkeyup="checkPassword()"/>
        <div id='message'></div>
        <div id="bars">
          <div></div>
        </div>
